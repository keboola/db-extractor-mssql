...
abstract class AbstractMSSQLTest extends ExtractorTest
{
    ...
    private function setupTables(): void
    {
        ...
        $this->pdo->exec("INSERT INTO [auto Increment Timestamp] (\"Weir%d Na-me\", Type, someInteger, someDecimal) VALUES ('mario', 'plumber', 1, 1.1)");
        $this->pdo->exec("INSERT INTO [auto Increment Timestamp] (\"Weir%d Na-me\", Type, someInteger, someDecimal) VALUES ('luigi', 'plumber', 2, 2.2)");
        $this->pdo->exec("INSERT INTO [auto Increment Timestamp] (\"Weir%d Na-me\", Type, someInteger, someDecimal) VALUES ('toad', 'mushroom', 3, 3.3)");
        $this->pdo->exec("INSERT INTO [auto Increment Timestamp] (\"Weir%d Na-me\", Type, someInteger, someDecimal) VALUES ('princess', 'royalty', 4, 4.4)");
        $this->pdo->exec("INSERT INTO [auto Increment Timestamp] (\"Weir%d Na-me\", Type, someInteger, someDecimal) VALUES ('wario', 'badguy', 5, 5.5)");
        sleep(1); // stagger the timestamps
        $this->pdo->exec("INSERT INTO [auto Increment Timestamp] (\"Weir%d Na-me\", Type, someInteger, someDecimal) VALUES ('yoshi', 'horse?', 6, 6.6)");
        // add unique key
